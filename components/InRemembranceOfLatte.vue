<template>
  <div class="relative flex flex-col items-center justify-center min-h-screen sm:items-center sm:pt-0">
    ...
    <div class="text-2xl items-center text-center">
      ...
      <h1>และผู้เสียหายออกมายอมรับในสิ่งที่ตนกระทำไว้และสมควรได้รับกับสิ่งที่ได้กระทำไว้กับผู้วายชนม์</h1>
  ...
  head: {
    ...
    meta: [
      ...createSEOMeta({
        ...
        title: "🌼 ระลึกถึง ธนพล แก้วมูล , 2541-2565",
        description: "หน้านี้จะถูกลบออกเมื่อ เต้ ได้รับความยุติธรรม และผู้เสียหายออกมายอมรับในสิ่งที่ตนกระทำไว้อย่างยุติธรรมและสมกับสิ่งที่ได้กระทำไว้กับผู้วายชนม์",
