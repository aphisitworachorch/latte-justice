<template>
  <div class="relative flex flex-col items-center justify-center min-h-screen sm:items-center sm:pt-0">
    <div class="items-center">
      <blockquote class="instagram-media" data-instgrm-captioned
                  data-instgrm-permalink="https://www.instagram.com/p/CjPPecuvBap/?utm_source=ig_embed&amp;utm_campaign=loading"
                  data-instgrm-version="14"
                  style=" background:#FFF; border:0; border-radius:3px; box-shadow:0 0 1px 0 rgba(0,0,0,0.5),0 1px 10px 0 rgba(0,0,0,0.15); margin: 1px; max-width:540px; min-width:326px; padding:0; width:99.375%; width:-webkit-calc(100% - 2px); width:calc(100% - 2px);">
        <div style="padding:16px;"><a
          href="https://www.instagram.com/p/CjPPecuvBap/?utm_source=ig_embed&amp;utm_campaign=loading"
          ...
          <p
            ...
            <a href="https://www.instagram.com/p/CjPPecuvBap/?utm_source=ig_embed&amp;utm_campaign=loading"
    ...
    <div class="text-2xl items-center text-center">
      <h1>ธนพล แก้วมูล , 2541-2565</h1>
      <h1>หน้านี้จะปรากฏจนกว่า เต้ จะได้รับความยุติธรรม</h1>
      <h1>และผู้กระทำความผิดออกมายอมรับในสิ่งที่ตนกระทำไว้และสมควรได้รับกับสิ่งที่ได้กระทำไว้กับผู้วายชนม์</h1>
      <h1>โดยกระบวนการยุติธรรมของประเทศไทย</h1>
    </div>
  </div>
</template>
...
export default Vue.extend({
  name: 'InRemembranceOfLatte',
  data: () => {
    return {
      imageFile: require('assets/image/InRemembranceOfLatte.png')
    }
  },
  head: {
    title: '🌼 ระลึกถึง ธนพล แก้วมูล , 2541-2565',
    meta: [
      ...createSEOMeta({
        author: "Arsanandha Aphisitworachorch",
        title: "🌼 ระลึกถึง ธนพล แก้วมูล , 2541-2565",
        description: "หน้านี้จะถูกลบออกเมื่อ เต้ ได้รับความยุติธรรม และผู้กระทำความผิดออกมายอมรับในสิ่งที่ตนกระทำไว้และสมควรได้รับกับสิ่งที่ได้กระทำไว้กับผู้วายชนม์ โดยกระบวนการยุติธรรมของประเทศไทย",
        image: require('assets/image/OGTae.png'),
        url: "https://latte-justice.arsanandha.xyz",
